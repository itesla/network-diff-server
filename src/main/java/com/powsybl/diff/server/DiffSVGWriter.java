...
public class DiffSVGWriter extends DefaultSVGWriter {
    ...
    private final ArrowsStyleProvider styleProvider;

    public DiffSVGWriter(ComponentLibrary componentLibrary, LayoutParameters layoutParameters, ArrowsStyleProvider styleProvider) {
